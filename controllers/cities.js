...
router.get('/historical/:zip', function(req, res){
  ...
  var url = "http://api.wunderground.com/api/b4b355346be47a17/planner_"+startDate+endDate+"/q/zmw:"+zip+".json";
...
router.get('/details/:zip', function(req, res){
  ...
  var url = "http://api.wunderground.com/api/b4b355346be47a17/conditions/q/zmw:"+zip+".json";
